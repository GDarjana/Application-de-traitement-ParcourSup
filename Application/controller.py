...
def home():
    if request.method=="POST":
        ...
        file.save(os.path.join("/Users/gdarji/Documents/Projet/Application/upload",file.filename))
        data = pd.read_csv("/Users/gdarji/Documents/Projet/Application/upload/"+filename)
        dico = {}
        for elem in data.id:
            dico[elem] = "test"
